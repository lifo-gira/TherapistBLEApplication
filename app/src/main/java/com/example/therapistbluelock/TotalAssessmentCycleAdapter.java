...
public class TotalAssessmentCycleAdapter extends RecyclerView.Adapter<TotalAssessmentCycleAdapter.ExerciseViewHolder2>{
    private final List<ExerciseCycleAssessment> exerciseList; // Use ExerciseCycleAssessment
    private final Context context;
    static String actpas;

    public TotalAssessmentCycleAdapter(List<ExerciseCycleAssessment> exerciseList, Context context) {
    ...
    @NonNull
    @Override
    public ExerciseViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.assess_cycle, parent, false);
        return new ExerciseViewHolder2(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ExerciseViewHolder2 holder, int position) {
...
//        }
    ...
    public class ExerciseViewHolder2 extends RecyclerView.ViewHolder {
        ...
        public ExerciseViewHolder2(@NonNull View itemView) {
            super(itemView);
