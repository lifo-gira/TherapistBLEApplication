...
public class AssessmentCycleAdapter extends RecyclerView.Adapter<AssessmentCycleAdapter.ExerciseViewHolder> {
    private final List<ExerciseCycleAssessment> exerciseList; // Use ExerciseCycleAssessment
    private final Context context;
    static String actpas;
    private OnItemClickListener onItemClickListener;

    public AssessmentCycleAdapter(Context context, List<ExerciseCycleAssessment> exerciseList, OnItemClickListener onItemClickListener, String actpas) {
...
//        }
    ...
    public int getItemCount() {
        Log.e("Extension lag test passive", String.valueOf(exerciseList.size()));
